...
# 소스 저장소 — 화면에서 코드를 바로 받아갈 수 있게 한다.
# ★ 주소를 코드에 박지 않는다. 포크하거나 옮기면 여기 한 줄만 고친다.
#   비우면(빈 문자열) 화면에서 그 자리가 통째로 사라진다 — 없는 링크를 만들지 않는다.
REPO_URL = "https://github.com/gabuki22/auto-report-stock"
# 화면에서 내려받게 할 자동화 스크립트. 저장소 루트 기준.
CLI_FILE = "run_pipeline.py"
